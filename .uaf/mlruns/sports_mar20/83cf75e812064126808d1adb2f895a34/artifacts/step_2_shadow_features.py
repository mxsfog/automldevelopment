...
from feature_engineering import (
    add_edge_nonlinear_features,
    add_ml_calibration_features,
    add_odds_features,
    add_sport_profitability_features,
    add_stake_features,
)
...
FEATURE_GROUPS = [
    ...
    ("2.2_edge_nonlinear", add_edge_nonlinear_features),
    ("2.3_sport_profitability", add_sport_profitability_features),
