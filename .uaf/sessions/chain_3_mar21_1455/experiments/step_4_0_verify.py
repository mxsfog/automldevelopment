...
Загрузка модели из предыдущей сессии chain_2_mar21_1432,
...
PREV_MODEL_DIR = Path("/mnt/d/automl-research/.uaf/sessions/chain_2_mar21_1432/models/best")
...
def main() -> None:
    ...
    with mlflow.start_run(run_name="chain/verify") as run:
        try:
            ...
            # Feature engineering (fit на train)
            ...
            # Воспроизведение 3-model ensemble (CB + LGBM + LR)
            ...
            # Сохраняем модель как baseline для этой сессии
