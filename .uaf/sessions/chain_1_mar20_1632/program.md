...
## Metadata
- session_id: chain_1_mar20_1632
- created: 2026-03-20T13:33:14.887909+00:00
- approved_by: pending
- approval_time: null
- budget_mode: fixed
- budget_summary: fixed: max 50 iterations, max ?h
- claude_model: claude-opus-4
- mlflow_experiment: uaf/chain_1_mar20_1632
...
- **Critical:** true
- **Status:** done
- **MLflow Run ID:** 9a52b1c2dfa64d6c94191d52eafddcf6
- **Result:** ROI bet_all = -3.07%, ROI random_50 = -5.97%
- **Conclusion:** Lower bound установлен. Все ставки дают ROI -3.07%.
...
- **Critical:** false
- **Status:** done
- **MLflow Run ID:** b4474bede67241839c2326dfa49cdeb3
- **Result:** ROI ML_Edge>=8 = -3.53%, ML_P_Model>=60% = 1.79%
- **Conclusion:** Rule-based не дает стабильного ROI. Val ROI 15% vs test -3.5% = overfitting.
...
- **Critical:** true
- **Status:** done
- **MLflow Run ID:** ed36e54dd11045788f8cb44ee5c5df2a
- **Result:** ROI = -1.40%, AUC = 0.7913, threshold=0.75, n=1061, WR=97%
- **Conclusion:** Линейная модель лучше bet_all но ROI отрицательный. Ставит на фаворитов.
...
- **Critical:** true
- **Status:** done
- **MLflow Run ID:** ffbf6d7b6d9b41e3abdba91b65e765f3
- **Result:** ROI = -2.86%, AUC = 0.7938, threshold=0.85, n=1642, WR=95%
- **Conclusion:** CatBoost early stop iter 40. Odds доминирует (79%). ROI отрицательный.
...
#### Step 2.1 — Full feature set (shadow trick)
- **Hypothesis:** 13 новых фичей (odds-derived, temporal, target encoding) улучшат ROI
- **Method:** shadow_feature_trick
- **Status:** done
- **MLflow Run ID:** af5bb532eab54c9fa26dc6399a3b1fc7
- **Result:** Delta ROI = -1.09%, Decision = rejected
- **Conclusion:** Target-encoded sport/market winrate доминирует (50%) — leakage. Отклонено.

#### Step 2.2 — Selective features (no target encoding)
- **Hypothesis:** Только odds-derived и value фичи без target encoding
- **Method:** shadow_feature_trick
- **Status:** done
- **MLflow Run ID:** 4e133287f1fb4a4a8c6eb3601a401de8
- **Result:** Delta ROI = +2.05%, Decision = accepted
- **Conclusion:** ROI с -2.86% до -0.81%. log_odds, implied_prob, parlay_complexity помогли.
...
- **Critical:** false
- **Status:** done
- **MLflow Run ID:** 08f848cba7814d6190b9ac33da9b76c8
- **Result:** ROI = 2.66%, AUC = 0.7945, threshold=0.65, n=2564
- **Conclusion:** Optuna depth=3, lr=0.059, no class weights. Первый положительный ROI.
...
- **Completed Steps:** 16
- **Best Result:** ROI = 7.32% (Optuna CB + ensemble + segment filter, step 4.12, val-selected t=0.60)
...
```bash
git add .
git commit -m "session chain_1_mar20_1632: step {step_id} [mlflow_run_id: {run_id}]"
```
