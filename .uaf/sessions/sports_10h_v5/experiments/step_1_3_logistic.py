"""Step 1.3: Linear baseline -- LogisticRegression с базовыми фичами."""
...
def main() -> None:
    ...
    with mlflow.start_run(run_name="phase1/step1.3_logistic_regression") as run:
        ...
        try:
            # Anti-leakage: split train into fit/val for threshold selection
            ...
            # Threshold selection on val (anti-leakage)
            ...
            # Classification metrics at default 0.5
            ...
            for fname, coef in zip(feature_cols, coefs, strict=True):
