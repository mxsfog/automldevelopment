"""Общие утилиты для экспериментов chain_3_mar20_1748."""
...
def add_elo_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Winrate и игры из teams через elo join
    ...
    # ELO diff (разница между командами)
